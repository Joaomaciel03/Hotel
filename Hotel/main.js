...
function cadastro_eventos(){
    ...
    let confirmacao_evento=prompt("Gostaria de efutuar a reserva? (Sim/Não)");
    while(confirmacao_evento!="Sim" && confirmacao_evento!="Não"){
        confirmacao_evento=prompt("Por favor, insira um valor válido.");
    }
    if(confirmacao_evento=="Sim"){
        alert(`${nomeUser} reserva efetuada com sucesso.`);
    }
    else if (confirmacao_evento=="Não"){
        alert(`${nomeUser}, reserva não efetuada`);
    }
    menu_cadastro_eventos();
}
...
function cadastro_buffet(){
    ...
    let confirmacao_buffet=prompt("Gostaria de efutuar a reserva? (Sim/Não)");
    while(confirmacao_buffet!="Sim" && confirmacao_buffet!="Não"){
        confirmacao_buffet=prompt("Por favor, insira um valor válido.");
    }
    if(confirmacao_buffet=="Sim"){
        alert(`${nomeUser} reserva efetuada com sucesso.`);
    }
    else if (confirmacao_buffet=="Não"){
        alert(`${nomeUser}, reserva não efetuada`);
    }
    menu_cadastro_eventos();
}
...
function ar_condicionado(){
    ...
    do{
        ...
        i+=1;
        confirma_ar=prompt(`Deseja informar novos dados, ${nomeUser}?(Sim/Não)`)
    }while(confirma_ar!="Não")
